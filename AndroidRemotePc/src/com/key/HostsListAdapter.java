...
public class HostsListAdapter implements ListAdapter {
	//
	private Vector<String> hosts;
	private Context context;
	
	public HostsListAdapter(Vector<String> hosts, Context context) {
		this.hosts = hosts;
	...
	private View inflateView(View cell) {
		if (cell == null) {
			...
			cell = inflater.inflate(R.layout.hostlistview, null);
		}
		return cell;
	}
