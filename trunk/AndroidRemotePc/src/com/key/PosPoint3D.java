...
public class PosPoint3D {
	public float x = 0;
	public float y = 0;
	public float z = 0;
	
	public static double dot(PosPoint3D a, PosPoint3D b) {
	 ...
	 */
	public static void cross(PosPoint3D a, PosPoint3D b, PosPoint3D out) {
	...
	public static void cross(float[] a, float[] b, PosPoint3D out) {
	...
	public static float length(PosPoint3D v) {
	...
	public static void setLength(PosPoint3D v, float len, float newlen) {
	...
	public static void normalize(PosPoint3D v) {
		float len = length(v);
		v.x /= len;
		v.y /= len;
		v.z /= len;
	...
	public static void copy(float[] a, PosPoint3D b) {
		b.x = a[0];
		b.y = a[1];
		b.z = a[2];
	}
	...
	public static void copy(PosPoint3D a, PosPoint3D b) {
		b.x = a.x;
		b.y = a.y;
		b.z = a.z;
	}
	
	public static void reverse(PosPoint3D v) {
		v.x *= -1;
		v.y *= -1;
		v.z *= -1;
	}
	...
	public static void rotateX(PosPoint3D v, double sinrot, double cosrot) {
		float y = v.y;
		float z = v.z;
		//
	...
	public static void rotateY(PosPoint3D v, double sinrot, double cosrot) {
		float x = v.x;
		float z = v.z;
		//
	...
	public static void rotateZ(PosPoint3D v, double sinrot, double cosrot) {
		float x = v.x;
		float y = v.y;
		//
	...
	public static void logVector(String appname, PosPoint3D v) {
