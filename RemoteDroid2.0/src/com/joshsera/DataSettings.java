...
//	private static final String PREFS_TRACKASSCROLL = "trackasscroll";
	...
	public static void init(Context con) {
		if (prefs == null) {
			...
			clickTime = prefs.getInt(DataSettings.PREFS_TAPTIME, 200);
			sensitivity = prefs.getInt(DataSettings.PREFS_SENSITIVITY, 0);
			scrollSensitivity = prefs.getInt(DataSettings.PREFS_SCROLL_SENSITIVITY, 50);
	...
	public static void setIp(String ip) throws Exception {
		...
		testIPValid(ip);
		edit.putString(DataSettings.PREFS_IPKEY, ip);
		edit.commit();
		DataSettings.ip = ip;
...
//	}
	...
	public static void setTapToClick(boolean tapToClick) {
		SharedPreferences.Editor edit = prefs.edit();
		edit.putBoolean(DataSettings.PREFS_TAPTOCLICK, tapToClick);
		edit.commit();
		DataSettings.tapToClick = tapToClick;
	}

	public static void setClickTime(int clickTime) {
		SharedPreferences.Editor edit = prefs.edit();
		edit.putInt(DataSettings.PREFS_TAPTIME, clickTime);
		edit.commit();
		DataSettings.clickTime = clickTime;
	}

	public static void setSensitivity(int sensitivity) {
		SharedPreferences.Editor edit = prefs.edit();
		edit.putInt(DataSettings.PREFS_SENSITIVITY, sensitivity);
		edit.commit();
		DataSettings.sensitivity = sensitivity;
	}

	public static void setScrollSensitivity(int scrollSensitivity) {
		SharedPreferences.Editor edit = prefs.edit();
		edit.putInt(DataSettings.PREFS_SCROLL_SENSITIVITY, scrollSensitivity);
		edit.commit();
		DataSettings.scrollSensitivity = scrollSensitivity;
	}

	public static void setScrollInverted(boolean scrollInverted) {
		SharedPreferences.Editor edit = prefs.edit();
		edit.putBoolean(DataSettings.PREFS_SCROLL_INVERTED, scrollInverted);
		edit.commit();
		DataSettings.scrollInverted = scrollInverted;
	}
